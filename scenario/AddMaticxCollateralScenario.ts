...
scenario.only(
  ...
  async (
    ...
    const newAssetConfig = {
      ...
      decimals: await maticx.decimals(), // 100 maticx == 50 usdc
      borrowCollateralFactor: exp(0.8, 18), // 100 maticx supply -> 80 maticx equi. usdc borrow -> 40 usdc
      liquidateCollateralFactor: exp(0.85, 18), // 85 maticx equi. -> x usdc
